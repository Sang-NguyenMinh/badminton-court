...
let NotificationController = class NotificationController {
    ...
    async sendBatchNotifications(body) {
        const tickets = await this.pushNotificationService.sendBatchPushNotifications(body.notifications);
        setTimeout(() => {
...
], NotificationController.prototype, "sendBatchNotifications", null);
